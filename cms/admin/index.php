            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i>  <a href="index.html">Dashboard</a>
                            </li>
                        </ol>
<!--
...
$subscriber_count=mysqli_num_rows($select_all_subscriber)
    ...
    $element_count = [$post_count,$post_published_count,$post_draft_count,$comments_count,$unapproved_comments_count,$user_count,$subscriber_count,$category_count];
